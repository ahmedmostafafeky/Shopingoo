                            ...
                            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbarFilter" aria-labelledby="offcanvasNavbarFilterLabel">
                                ...
                                <div class="offcanvas-body account-menu">
                                    <div class="list-group w-100 rounded-0">
                                        ...
                                        <a href="/profile/edit" class="list-group-item active"><i class="bi bi-pencil me-2"></i>Edit Profile</a>
                                    ...
                                    <div class="row row-cols-1 g-3">
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" name="name" class="form-control rounded-0" id="floatingInputName" value="{{$userdata['name']}}">
                                                <label for="floatingInputName">Name</label>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" name="phone" class="form-control rounded-0" id="floatingInputNumber"  value="{{$userdata['phone']}}">
                                                <label for="floatingInputNumber">Mobile Number</label>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" name="email" class="form-control rounded-0" id="floatingInputEmail"  value="{{$userdata['email']}}">
                                                <label for="floatingInputEmail">Email</label>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" name="address" class="form-control rounded-0" id="floatingInputLocation" placeholder="Location" value="{{$userdata['address']}}">
